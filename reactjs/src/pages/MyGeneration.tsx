...
const MyGeneration = () => {
  ...
  const apectRatioClassMap: Record<string, string> = {
            "16:9": "aspect-video",
            "4:3": "aspect-square",
            "1:1": "aspect-[9/16]",
  };
        ...
        {!loading && thumbnails.length > 0 && (
          <div className="columns-1 sm:columns-2 lg:columns-3 2xl:columns-4 gap-8">
            {thumbnails.map((thumb: IThumbnail) => {
             const aspectClass = apectRatioClassMap[thumb.aspect_ratio || "16:9"];
             
             return (
              <div key={thumb._id} 
              onClick={() => navigate(`/generate/${thumb._id}`)} 
              className="mb-8 relative cursor-pointer group rounded-2xl 
              ...
              <div className="p-4 space-y-2">
                <h3 className="text-sm font-semibold text-zinc-200">{thumb.title}</h3>
